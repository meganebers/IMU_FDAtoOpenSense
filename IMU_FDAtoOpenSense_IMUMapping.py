...
def main(input_folder, imu_sensors, output_folder, SUBJ, TRIAL):
    ...
    SUBJ_folder = os.path.join(input_folder, SUBJ)
    for file in os.listdir(SUBJ_folder):

        filename = f'{SUBJ}_{TRIAL}.csv'
        if filename in file: 
            ...
            raise FileNotFoundError(f"No file matching the trial identifier '{TRIAL}' was found in the folder '{SUBJ_folder}'.")
...
input_folder = '/home/mebers/code/biomech/Parkinsons_Data'
